...
def build_resnext50_32x4d(num_classes: int) -> nn.Module:
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Train ResNeXt-50 (32x4d) on OrganAMNIST")
    add_common_cli(parser, defaults)
    _ = parser.parse_args()

    run_training(build_resnext50_32x4d, defaults)
